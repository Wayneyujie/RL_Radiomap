...
class curve_generator:
    ...
    def plot_curve(self, curve, style='-g', show_way_points=True, show_direction=False, **kwargs):
        ...
        self.ax.quiver(path_x_list, path_y_list, u_list, y_list, color='b', scale=20, scale_units='height')
...
if __name__ == '__main__':
    ...
    cg = curve_generator(x_limit = [100, 300], y_limit=[100, 200])
    # curve = cg.generate_curve('dubins', point_list, 0.1, 2, include_gear=False)

    # set all direction to zero
    start_position = [120.0, 170.0, 0]
    goal1_position = [180.0, 169.5, 0]
    goal2_position = [247.5, 169.0, 0]
    goal3_position = [254.5, 129.0, 0]
    goal4_position = [240, 123, 0]
    goal5_position = [221, 125, 0]
    goal6_position = [209, 135.0, 0]
    finish_position = [202, 150.0, 0]
    ...
    point_list = [start_point, goal1_point, goal2_point, goal3_point, goal4_point, goal5_point, goal6_point, finish_point]

    curve = cg.generate_curve('line', point_list, step_size=10, radius=2, include_gear=False) # step_size = 10 for visualization
    print(curve)
    # curve = cg.generate_curve('line', point_list, 0.1, 2, include_gear=False) # step_size = 0.1
