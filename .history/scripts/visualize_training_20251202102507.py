...
class TrainingVisualizer:
    def __init__(self, env, agent, update_interval=10, save_animation=False, output_dir="training_visualization"):
        """
        Args:
            env: 训练环境
            agent: 训练中的智能体
...
def visualize_training_episode(env, agent, max_steps=1000, use_rl=True, use_iqn=True):
    """
    可视化单个训练episode
